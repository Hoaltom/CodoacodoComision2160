            ...
            <div class="row">
                <div class="col col-md-10 offset-md-1 col-lg-8 offset-lg-2 pt-3">
                    <div class="card-group">
                        <div class="card">
                            <div class="card-body border border-primary mr-1 p-4">
                        ...
                        <div class="card">
                            <div class="card-body border border-success mr-1 p-4">
                        ...
                        <div class="card">
                            <div class="card-body border border-warning mr-1 p-4">
            ...
            <div class="row">
                <div class="col col-md-10 offset-md-1 col-lg-8 offset-lg-2 pt-2">
                    <form>
                        <div class="form-row">
                        <div class="d-flex">
                            <div class="form-group col-6 col-md-6 me-2">
                            ...
                            <div class="d-flex">
                            <div class="form-group col-12 col-md-6 pt-3 me-2">
